...
This is an R Markdown document. This Markdown file contains the R code for reading gene expression data from csv file to r, and add types and clean the data.


Create Cross-study validation dataset
JUDE_AML dataset
```{r,eval=FALSE}
...
delete the last variable in JUDE
```{r,eval=FALSE}
load('JUDE.Rdata')
type=jude$type
